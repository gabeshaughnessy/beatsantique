<div id="c7s-media" class="c7s-metabox">
	  	...
	  	<table>
	  		<tr>
	  			<td scope="row" colspan="2">
	  				<label><strong><?php echo __( 'Media Source URL', 'framework' ); ?></strong></label>
	  	...
	  	<table>
	  		...
	  		<tr>
	  			<td>
	  				...
	  				<p><?php echo __( 'To use this option, simply copy and past the URL of media content from an ', 'framework' ) . '<a href="http://codex.wordpress.org/Embeds#Okay.2C_So_What_Sites_Can_I_Embed_From.3F" target="_blank">' . __( 'approved site', 'framework' ) . '</a>' . __( '(e.g. vimeo.com). ', 'framework' ); ?></p>
	  			</td>
	  		</tr>
	  		<tr>
	  			<td>
	...
	<?php //if( $mb->get_the_value( 'media_source' ) || $mb->get_the_value( 'media_embed_code' ) ) : ?>
	  <div class="c7s-embed-preview" style="padding-top: 8px">
	  		<?php //echo apply_filters( 'get_media', get_the_ID(), 258, 258, false ); ?>
	  </div>
	<?php //endif; ?>
